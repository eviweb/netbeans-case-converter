...
@ActionID(
        ...
        id = "fr.evidev.netbeans.caseconverter.ui.actions.ConvertToPascalCaseAction"
)
@ActionRegistration(
        displayName = "#CTL_ConvertToPascalCaseAction"
)
@Messages("CTL_ConvertToPascalCaseAction=PascalCase")
